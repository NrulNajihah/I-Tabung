<%-- 
    Document   : ListProE
    Created on : 1 Oct 2024, 2:55:40 pm
    Author     : NAJIHAH
--%>
                                    ...
                                    <ul class="nav nav-collapse">
                                        ...
                                        <li>
                                            <a href="<%=request.getContextPath()%>/VoteServlet?action5=listvt" >
                                                <span class="sub-item">Maklumat Utma</span>
                                            </a>
                                        </li>
                                        <li>
                                            ...
                                            <table
                                                ...
                                                <tbody>
                                                    <c:forEach var="project" items="${listofProject}">
                                                        <tr onclick="location.href = 'ExpensesServlet?path4=newExp&id=${project.id}';" style="cursor:pointer;">
