<%-- 
    Document   : Expense
    Created on : 19 Aug 2024, 4:00:19 pm
    Author     : NAJIHAH
--%>
                    ...
                    <div class="page-inner">
                        <div class="page-header">
                            ...
                            <ul class="breadcrumbs mb-3">
                                ...
                                <li class="nav-item">
                                    <a href="<%=request.getContextPath()%>/ProjectServlet?action3=listProE">Senarai Project(Perbelanjaan)</a>
                                </li>
                                <li class ="separator">
                                    <i class ="fas fa-arrow-right"></i>
                                </li>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a class="btn btn-info ms-auto" href="<%=request.getContextPath()%>/ExpenseServlet?action4=listExpFull&id=${project.id}">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <c:if test="${expense == null}">
                                        <form action="ExpenseServlet" method="post" enctype="multipart/form-data">
                                            <input type="hidden" name="action4" value="insertExp">
