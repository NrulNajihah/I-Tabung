<%-- 
    Document   : ProjectAd
    Created on : 26 Sep 2024, 10:04:25 am
    Author     : NAJIHAH
--%>
                                ...
                                <div class="card">
                                    ...
                                    <c:if test="${project == null}">
                                        <form action="AdminServlet" method="post">
                                            <input type="hidden" name="path1" value="insertPro">
                                        </c:if>
                                        <c:if test="${project != null}">
                                            <form action="AdminServlet" method="post" >
                                                    ...
                                                    <c:forEach var="project" items="${listProject}">
                                                        <tr>
                                                            ...
                                                            <td style="display: flex; justify-content: center; align-items: center; gap: 10px;">
                                                                ...
                                                                <a href="<%=request.getContextPath()%>/AhliServlet?path2=listMmb&id=${project.id}"><button
                                                                        type="button"
                                                                ...
                                                                <a href="AdminServlet?path1=editDate&id=<c:out value='${project.id}' />"><button
                                                                        type="button"
                                                                        title="Extend Date"
                                                                        class="btn btn-icon btn-round btn-black"
                                                                        >
                                                                ...
                                                                <a href="AdminServlet?path1=editPro&id=<c:out value='${project.id}' />">
                                                                    <button
                                                                        type="button"
                                                                        title="Edit Project"
                                                                ...
                                                                <a href="AdminServlet?path1=deletePro&id=<c:out value='${project.id}' />">
                                                                    <button
                                                                        type="button"
                                                                        title="Remove"
