<%-- 
    Document   : Incomes
    Created on : 1 Oct 2024, 11:42:35 am
    Author     : NAJIHAH
--%>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                <label for="total_All">Jumlah Peruntukan(RM)</label>
                                                <input
                                                    id="total_All"
                                                    type="text"
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a class="btn btn-info ms-auto" href="<%=request.getContextPath()%>/IncomesServlet?path3=listIncFull&id=${project.id}">
                            ...
                            <div class="card">
                                ...
                                <c:if test="${income == null}">
                                    <form action="IncomesServlet" method="post">
                                        <input type="hidden" name="path3" value="insertInc">
