<%-- 
    Document   : FullInc
    Created on : 26 Aug 2024, 12:14:34 pm
    Author     : NAJIHAH
--%>
                                                        ...
                                                        <c:forEach var="income" items="${listInc}">
                                                            <tr>
                                                                ...
                                                                <td><div class="form-button-action">
                                                                        <a href="<%=request.getContextPath()%>/IncomeServlet?action5=editInc&iID=<c:out value='${income.iID}'/>&id=${project.id}">
                                                                            <button
                                                                                type="button"
                                                                                title="Edit Task"
                                                                        ...
                                                                        <a href="<%=request.getContextPath()%>/IncomeServlet?action5=deleteInc&iID=<c:out value='${income.iID}'/>&id=${project.id}">
                                                                            <button
                                                                                type="button"
                                                                                title="Remove"
                                                                                class="btn btn-link btn-danger"
                                                                                data-original-title="Remove"
                                                                                <c:if test="${hasExpense}">
                                                                                    disabled
                                                                                </c:if>
                                                                                >
