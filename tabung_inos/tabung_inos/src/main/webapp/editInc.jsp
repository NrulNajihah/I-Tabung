<%-- 
    Document   : editInc
    Created on : 28 Aug 2024, 11:53:36 am
    Author     : NAJIHAH
--%>
                    ...
                    <div class="page-inner">
                        <div class="page-header">
                            ...
                            <ul class="breadcrumbs mb-3">
                                ...
                                <li class="nav-item">
                                    <a href="<%=request.getContextPath()%>/ProjectServlet?action3=listProInc">Senarai Projek(Peruntukan)</a>
                                </li>
                                <li class="separator">
                                    <i class="fas fa-arrow-right"></i>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="<%=request.getContextPath()%>/IncomeServlet?action5=listIncFull&id=${project.id}">Maklumat Lanjut</a>
                                </li>
                                <li class="separator">
                                    <i class="fas fa-arrow-right"></i>
                                </li>
                                <li class="nav-item">
                                    <a href="<%=request.getContextPath()%>/IncomeServlet?action5=editInc&id=${project.id}">Edit Peruntukan</a>
                                </li>
                            </ul>
                        </div>
                        <div class="row">
                                ...
                                <div class="card">
                                    ...
                                    <c:if test="${income != null}">
                                        <form action="IncomeServlet" method="post">
                                            <input type="hidden" name="action5" value="updateInc">
