<%-- 
    Document   : ReportAd
    Created on : 8 Oct 2024, 8:52:17 am
    Author     : NAJIHAH
--%>
                    ...
                    <div class="page-inner">
                        <div class="page-header">
                            ...
                            <ul class="breadcrumbs mb-3">
                                ...
                                <li class="nav-item">
                                    <a href="<%=request.getContextPath()%>/AdminServlet?path1=listReport">Senarai Projek</a>
                                </li>
                            </ul>
                        </div>
                        <div class="row">
                                            ...
                                            <table
                                                ...
                                                <tbody>
                                                    <c:forEach var="project" items="${listofProject}">
                                                        <tr onclick="location.href = 'ExpensesServlet?path4=report&id=${project.id}';" title="Download Report" style="cursor:pointer;">
