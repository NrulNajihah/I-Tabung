<%-- 
    Document   : ExpFull
    Created on : 26 Aug 2024, 2:29:32 pm
    Author     : NAJIHAH
--%>
                                                        ...
                                                        <c:forEach var="expense" items="${listofExp}">
                                                            <tr>
                                                                ...
                                                                <td><div class="form-button-action">
                                                                        <a href="<%=request.getContextPath()%>/ExpenseServlet?action4=editExp&eID=<c:out value='${expense.eID}'/>&id=${project.id}">
                                                                            <button
                                                                                type="button"
                                                                                title="Edit Task"
                                                                        ...
                                                                        <a href="ExpenseServlet?action4=deleteExp&eID=<c:out value='${expense.eID}'/>&id=${project.id}">
                                                                            <button
                                                                                type="button"
                                                                                title="Remove"
