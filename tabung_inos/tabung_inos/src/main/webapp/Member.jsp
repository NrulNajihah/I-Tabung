<%-- 
    Document   : Member
    Created on : 22 Sep 2024, 11:55:35 am
    Author     : NAJIHAH
--%>
                    ...
                    <div class="page-inner">
                        <div class="page-header">
                            ...
                            <ul class="breadcrumbs mb-3">
                                ...
                                <li class="nav-item">
                                    <a href="<%=request.getContextPath()%>/MemberServlet?action10=listMmb&id=${project.id}">Senarai Ahli</a>
                                </li>
                            </ul>
                        </div>
                        <div class="row">
                                                    ...
                                                    <c:forEach var="member" items="${ListMmb}">
                                                        <tr>
                                                            ...
                                                            <td><div class="form-button-action">
                                                                    <a href="MemberServlet?action10=deleteMmb&mID=<c:out value='${member.mID}'/>&id=${project.id}">
                                                                        <button
                                                                            type="button"
                                                                            title="Remove"
                            ...
                            <div class="card">
                                ...
                                <c:if test="${member == null}">
                                    <form action="MemberServlet" method="post">
                                        <input type="hidden" name="action10" value="insertMmb">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="form-group">
                                                    <label for="defaultSelect">Ahli</label>
