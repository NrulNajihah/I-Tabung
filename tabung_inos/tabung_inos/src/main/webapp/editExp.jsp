<%-- 
    Document   : editExp
    Created on : 28 Aug 2024, 12:06:09 pm
    Author     : NAJIHAH
--%>
                    ...
                    <div class="page-inner">
                        <div class="page-header">
                            ...
                            <ul class="breadcrumbs mb-3">
                                ...
                                <li class="nav-item">
                                    <a href="<%=request.getContextPath()%>/ProjectServlet?action3=listProE">Senarai Projek(Perbelanjaan)</a>
                                </li>
                                <li class ="separator">
                                    <i class ="fas fa-arrow-right"></i>
                                </li>
                                <li class ="nav-item">
                                    <a href="<%=request.getContextPath()%>/ExpenseServlet?action4=newExp&id=${project.id}">Perbelanjaan</a>
                                </li>
                                <li class ="separator">
                                    <i class ="fas fa-arrow-right"></i>
                                </li>
                                <li class ="nav-item">
                                    <a href="<%=request.getContextPath()%>/ExpenseServlet?action4=listExpFull&id=${project.id}">Maklumat Lanjut</a>
                                </li>
                                <li class ="separator">
                                    <i class ="fas fa-arrow-right"></i>
                                </li>
                                <li class ="nav-item">
                                    <a href="<%=request.getContextPath()%>/ExpenseServlet?action4=editExp&id=${project.id}">Edit Perbelanjaan</a>
                                </li>
                            </ul>
                        </div>
                        <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="d-flex align-items-center">
                                            <h4 class="card-title">Edit Perbelanjaan</h4>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title">Maklumat Perbelanjaan</div>
                                    </div>
                                    <!-- Ensure form is displayed if expense is not null -->
                                    <c:if test="${expense != null}">
                                        <form action="ExpenseServlet" method="post">
                                            <input type="hidden" name="action4" value="updateExp">
                                            <input type="hidden" name="eID" value="<c:out value='${expense.eID}'/>">
                                        </c:if>
                                        ...
                                        <div class="card-body">
                                            <div class="row" >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="claim" value="<c:out value='${expense.claim}'/>"/>
                                                </div>
                                                <div class="form-group">
                                                    <label for="edate">Tarikh</label>
                                                    <input type="date" class="form-control form-control-lg" name="edate" value="<c:out value='${expense.edate}'/>"/>
                                                    <input type="hidden" class="form-control form-control-lg" name="noPO" value="-"/>
                                                </div>
                                                <div class="form-group">
                                                    <label for="total_Exp">Perbelanjaan(RM)</label>
                                                    <input type="text" class="form-control form-control-lg" name="total_Exp" value="<c:out value='${expense.total_Exp}'/>"/>
                                                </div>
                                            </div>
                                        </div>
