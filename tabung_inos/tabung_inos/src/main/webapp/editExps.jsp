<%-- 
    Document   : editExps
    Created on : 1 Oct 2024, 3:26:51 pm
    Author     : NAJIHAH
--%>
                    ...
                    <div class="page-inner">
                        <div class="page-header">
                            ...
                            <ul class="breadcrumbs mb-3">
                                ...
                                <li class="nav-item">
                                    <a href="<%=request.getContextPath()%>/AdminServlet?path1=listProE">Senarai Project(Perbelanjaan)</a>
                                </li>
                                <li class ="separator">
                                    <i class ="fas fa-arrow-right"></i>
                                </li>
                                ...
                                <li class ="nav-item">
                                    <a href="<%=request.getContextPath()%>/ExpensesServlet?path4=editExp&id=${project.id}">Edit Perbelanjaan</a>
                                </li>
                            </ul>
                        </div>
                        <div class="row">
                                ...
                                <div class="card">
                                    ...
                                    <c:if test="${expense != null}">
                                        <form action="ExpensesServlet" method="post">
                                            <input type="hidden" name="path4" value="updateExp">
                                        ...
                                        <div class="card-body">
                                            <div class="row" >
                                                ...
                                                <div class="form-group">
                                                    <label for="noPO">NO Po/ Baucer</label>
                                                    <input type="text" class="form-control form-control-lg" name="noPO" value="<c:out value='${expense.noPO}'/>"/>
                                                </div>
                                                <div class="form-group">
