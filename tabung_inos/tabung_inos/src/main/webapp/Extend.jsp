<%-- 
    Document   : Extend
    Created on : 23 Sep 2024, 3:07:53 pm
    Author     : NAJIHAH
--%>
                    ...
                    <div class="page-inner">
                        <div class="page-header">
                            ...
                            <ul class="breadcrumbs mb-3">
                                ...
                                <li class="nav-item">
                                    <a href="<%=request.getContextPath()%>/ExtendServlet?action11=listExt&id=${project.id}">Tarikh Lanjutan</a>
                                </li>
                            </ul>
                        </div>
                        <div class="row">
                            ...
                            <div class="card">
                                ...
                                <c:if test="${project != null}">
                                    <form action="ProjectServlet" method="post" >
                                        <input type="hidden" name="action3" value="updateDate">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-lg-4">
                                                ...
                                                <div class="form-group">
                                                    <label for="largeInput">Tarikh Lanjutan</label>
                                                    <input
                                                        type="date"
