...
private MemberDAO memberDAO;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String action = request.getParameter("action10");

        System.out.println("MemberServlet ==> Action10 = " + action);
    ...
    private void displayNewMmbForm(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("List of member retrieved: " + mmbList.size());
            ...
            RequestDispatcher dispatcher = sc.getRequestDispatcher("/Member.jsp");
   ...
   private List<User> getUser(String role) throws SQLException, ClassNotFoundException {
    ...
    private void createMmb(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.sendRedirect(request.getContextPath() + "/MemberServlet?action10=listMmb&id=" + id);

        } catch (ClassNotFoundException ex) {
            Logger.getLogger(MemberServlet.class.getName()).log(Level.SEVERE, null, ex);
            throw new ServletException("Class not found error occurred", ex);
        } catch (SQLException ex) {
            Logger.getLogger(MemberServlet.class.getName()).log(Level.SEVERE, "SQL error occurred", ex);
