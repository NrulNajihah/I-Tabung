...
public class IncomesServlet extends HttpServlet {
   ...
   private IncomeDAO incDAO;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("IncomesServlet ==> path3 = " + path);
        ...
        try {
            ...
            Logger.getLogger(IncomesServlet.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void displayNewIncForm(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("List of income retrieved: " + IncList.size());
            ...
            RequestDispatcher dispatcher = sc.getRequestDispatcher("/Incomes.jsp");
    ...
    private void displayEditIncForm(HttpServletRequest request, HttpServletResponse response)
        ...
        if (IDStr != null && !IDStr.isEmpty()) {
            ...
            ServletContext sc = getServletContext();
            RequestDispatcher dispatcher = sc.getRequestDispatcher("/editIncs.jsp");
            dispatcher.forward(request, response);
        }
    }
    ...
    private void createInc(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.sendRedirect(request.getContextPath() + "/IncomesServlet?path3=listInc&id=" + id);

        } catch (ClassNotFoundException ex) {
            Logger.getLogger(IncomesServlet.class.getName()).log(Level.SEVERE, null, ex);
            throw new ServletException("Class not found error occurred", ex);
        } catch (SQLException ex) {
            Logger.getLogger(IncomesServlet.class.getName()).log(Level.SEVERE, "SQL error occurred", ex);
    ...
    private void retrieveIncFull(HttpServletRequest request, HttpServletResponse response)
        ...
        // Forward the request to the JSP page for display
        request.getRequestDispatcher("/FullIncs.jsp").forward(request, response);
    }
    ...
    private void updateInc(HttpServletRequest request, HttpServletResponse response)
        ...
        BigDecimal newTotalAll = incDAO.calculateTotalAllForProject(id);
            ...
            response.sendRedirect(request.getContextPath() + "/IncomesServlet?path3=listIncFull&id=" + id);
        } catch (SQLException ex) {
            Logger.getLogger(IncomesServlet.class.getName()).log(Level.SEVERE, "SQL error occurred", ex);
    ...
    try {
        ...
        Logger.getLogger(IncomesServlet.class.getName()).log(Level.SEVERE, "SQL error occurred", e);
